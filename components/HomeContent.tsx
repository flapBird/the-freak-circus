    ...
    <>
      ...
      <SidebarLayout>
        ...
        <p className="mt-3 text-xs leading-relaxed text-circus-muted border-l-2 border-circus-gold/30 pl-3">
          {tMsg(locale, 'ui.playerDisclaimer')}
        </p>
        <article className="prose-circus mt-8">
          ...
          <div className="my-8 relative overflow-hidden rounded-sm border border-circus-border">
            <SafeImage src="/images/home/about-game.webp" alt={tMsg(locale, 'ui.aboutImageAlt')} width={800} height={360} priority
              className="w-full h-auto" fallback={tMsg(locale, 'ui.aboutImageAlt')} />
          </div>
          ...
          <div className="my-8 relative overflow-hidden rounded-sm border border-circus-border opacity-80">
            <SafeImage src="/images/home/characters.webp" alt={tMsg(locale, 'ui.charactersImageAlt')} width={800} height={280}
              className="w-full h-auto" fallback={tMsg(locale, 'ui.charactersImageAlt')} />
          </div>
          ...
          <div className="my-8 relative overflow-hidden rounded-sm border border-circus-border">
            <SafeImage src="/images/home/gameplay.webp" alt={tMsg(locale, 'ui.gameplayImageAlt')} width={800} height={280}
              className="w-full h-auto" fallback={tMsg(locale, 'ui.gameplayImageAlt')} />
          </div>
          ...
          <div className="my-8 relative overflow-hidden rounded-sm border border-circus-border opacity-70">
            <SafeImage src="/images/home/faq.webp" alt={tMsg(locale, 'ui.faqImageAlt')} width={800} height={260}
              className="w-full h-auto" fallback={tMsg(locale, 'ui.faqImageAlt')} />
          </div>
